...
const minus3multiply5add10 = compose(
  add10, 
  multiply5, 
  minus3
)
...
const logger = (store) => (next) => (action) => {
  ...
  console.log('%c prevState', 'color: #4cd137', JSON.stringify(prevState, null, 2));
  console.log('%c nextState', 'color: #e84118', JSON.stringify(nextState, null, 2));
